  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b from-blue-900 to-black text-white">
      ...
      <div className="mt-4 flex gap-4">
        <button
          onClick={toggleTimer}
          className={`px-3 py-1 rounded-lg text-lg font-semibold transition duration-300 ${
            timerRunning ? "bg-yellow-500 hover:bg-yellow-700" : "bg-green-500 hover:bg-green-700"
          }`}
        >
          {timerRunning ? "Pause Timer" : "Start Timer"}
        ...
        <button
          onClick={resetCounter}
          className="px-3 py-1 bg-red-600 hover:bg-red-800 rounded-lg text-lg font-semibold transition duration-300"
        >
          Reset
        </button>
      </div>
